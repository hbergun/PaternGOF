...
namespace VehicleFactory
{
    ...
    {
        public static IVehicleFactory GetFactory(string CarBrand)
        {
            ...
            if (type != null)
                return (IVehicleFactory)Activator.CreateInstance(type,true); //first paramater:Type Name   After:Params Constructor 
            else
                return null;
        }
    }
